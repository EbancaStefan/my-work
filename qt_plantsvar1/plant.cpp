...
{
    return (m_scientificName.compare(other.m_scientificName, Qt::CaseInsensitive) < 0 ); //return <1 if param 1 < param 2 | 0 if equal | 1 if param2> param1
    //daca numele de la planta mea e mai mic decat cealalta planta return true;
}
